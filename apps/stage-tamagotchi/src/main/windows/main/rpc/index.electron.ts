...
export async function setupMainWindowElectronInvokes(params: {
  ...
  createNowPlayingService({ context, engine: params.nowPlaying, window: params.window })
  createLiveChatService({ context, service: params.liveChat, window: params.window, unibarrageManager: params.unibarrageManager })

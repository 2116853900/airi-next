...
Taf.BinBuffer = function (t) {
  ...
  this.len = 0,
  this.position = 0,
  t != null && void 0 != t && t instanceof Taf.BinBuffer && (this.buf = t.buf,
  this.vew = new DataView(this.buf),
  this.len = t.length,
  this.position = t.position),
  t != null && void 0 != t && t instanceof ArrayBuffer && (this.buf = t,
  this.vew = new DataView(this.buf),
...
Taf.BinBuffer.prototype.allocate = function (t) {
  ...
  this.buf == null || this.buf.length <= t) {
    const e = new ArrayBuffer(Math.max(256, 2 * t))
    this.buf != null && (new Uint8Array(e).set(new Uint8Array(this.buf)),
    this.buf = void 0),
    this.buf = e,
    this.vew = void 0,
    this.vew = new DataView(this.buf)
...
Taf.BinBuffer.prototype.writeBytes = function (t) {
  t.length != 0 && t.buf != null && (this.allocate(t.length),
  ...
  switch (type) {
    ...
    case Taf.DataHelp.EN_SIMPLELIST: {
      ...
      if (head.type != Taf.DataHelp.EN_INT8) {
        throw new Error(`skipField with invalid type, type value: ${type},${head.type}`)
      }
...
Taf.JceInputStream.prototype.readStruct = function (t, e, i) {
  ...
  if (r.type != Taf.DataHelp.EN_STRUCTBEGIN)
    throw new Error(`read struct type mismatch, tag: ${t}, get type:${r.type}`)
...
Taf.Wup.prototype.encode = function () {
  const t = new Taf.JceOutputStream()
  this.iVersion == 3 ? t.writeMap(0, this.newdata) : t.writeMap(0, this.data),
...
Taf.Util.str2ab = function (t) {
  let e; const i = t.length; const r = new Array(i)
  for (e = 0; i > e; ++e)
    r[e] = t.charCodeAt(e)
...
Taf.Util.ajax = function (t, e, i, r) {
  ...
  const s = function () {
    n.readyState === 4 && (n.status === 200 || n.status === 304 ? i(Taf.Util.str2ab(n.response)) : r(n.status),
